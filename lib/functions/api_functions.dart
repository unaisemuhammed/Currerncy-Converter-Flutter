...
class ApiFunctionsController extends GetxController {
  List<String> Keys = [];
  ...
  Future<String> exchangeCurrencies(String source, String target,) async {
    final response = await http.get(Uri.parse(
        'https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/currencies/${source.toLowerCase()}/${target.toLowerCase()}.json'));
